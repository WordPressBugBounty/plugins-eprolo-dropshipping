...
class Eprolo_AJAX extends Eprolo_OptionsManager {
	...
	public function eprolo_disconnect() {
		...
		if (!isset( $_POST['eprolo_nonce_field'] ) || !wp_verify_nonce( sanitize_text_field($_POST['eprolo_nonce_field']), 'eprolo_form_action' )) {
			wp_send_json_success(array( 'msg'  => 'Please refresh the page', 'code' => '-1' ));
			exit;
		}

		if (!current_user_can("manage_options")) {
			wp_send_json_success(array( 'msg'  => 'This operation requires administrator permissions to proceed', 'code' => '-1' ));
			exit;
		}
