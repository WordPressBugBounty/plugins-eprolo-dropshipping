...
if(eprolo_connected==1){//已链接、
	...
	jQuery("#Connect_to_EPROLO").attr("href",server_domain+"woocommerce_installPre.html?domain="+encodeURIComponent(window.location.href)); 
...
function eprolo_disconnect() {
       ...
       var eprolo_user_id= jQuery("#eprolo_user_id").val();   
        ...
        data: {
            ...
            'eprolo_nonce_field': jQuery("#eprolo_nonce_field").val()
        },
